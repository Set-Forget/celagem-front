...
const styles = StyleSheet.create({
  ...
  // Columnas para la tabla de nota de crédito (7 columnas)
        ...
        <View style={styles.container}>
          ...
          <View style={styles.gridContainer}>
            <View style={styles.gridItem}>
              <Text style={styles.sectionTitle}>DATOS DEL CLIENTE/PROVEEDOR</Text>
              <View style={styles.row}>
          ...
          <View style={styles.bottomSection}>
            <View style={styles.infoSection}>
              ...
              <View style={styles.infoList}>
                ...
                <Text style={styles.infoItem}>
                  • Esta nota de crédito reduce el saldo pendiente de la factura original
                </Text>
                <Text style={styles.infoItem}>• Los impuestos se calculan sobre el valor creditado</Text>
              </View>

              <Text style={styles.conditionsTitle}>CONDICIONES:</Text>
              <View style={styles.conditionsList}>
                <Text style={styles.conditionsItem}>
                  1. Esta nota de crédito debe ser aplicada contra la factura original
                </Text>
                <Text style={styles.conditionsItem}>
                  2. Los productos devueltos deben estar en condiciones originales
                </Text>
                <Text style={styles.conditionsItem}>3. El crédito se aplicará según los términos acordados</Text>
                <Text style={styles.conditionsItem}>4. Conservar este documento para efectos contables y fiscales</Text>
              </View>
            </View>
