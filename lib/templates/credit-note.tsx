...
const CreditNotePDF: React.FC<{ data: CreditNoteDetail }> = ({ data }) => {
  ...
  return (
    <PDF
      options={{
        title: `Nota de Crédito ${data.number}`,
      }}
    >
      <div className="flex justify-between mb-6 text-xs gap-5">
        <div className="w-full px-3">
          <h1 className="mb-5 text-2xl font-bold">NOTA DE CRÉDITO</h1>
          <div className="flex justify-between">
            <span className="inline-block">Nota de Crédito No:</span>
      ...
      <div className="grid grid-cols-2 gap-5 mb-6 text-xs">
        <div className="bg-[#f8f9fa] p-3 rounded-lg">
          <h3 className="mb-4 text-sm font-bold">DATOS DEL CLIENTE/PROVEEDOR</h3>
          <div className="flex justify-between">
        ...
        <div className="bg-[#f8f9fa] p-3 rounded-lg">
          <h3 className="mb-4 text-sm font-bold">DATOS DE LA NOTA DE CRÉDITO</h3>
          <div className="flex justify-between">
            <span>Número:</span>
            <span className="font-medium">
              <strong>{data.number}</strong>
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="text-xs">
          ...
          <ul className="pl-5 m-0 list-disc">
            ...
            <li>Esta nota de crédito reduce el saldo pendiente de la factura original</li>
          ...
          <ol className="pl-5 m-0 list-decimal">
            <li>Esta nota de crédito debe ser aplicada contra la factura original</li>
            <li>Los productos devueltos deben estar en condiciones originales</li>
            <li>El crédito se aplicará según los términos acordados</li>
            <li>Conservar este documento para efectos contables y fiscales</li>
          </ol>
        </div>
        ...
        <div className="bg-[#f8f9fa] p-3 rounded-lg">
          ...
          <p className="mt-2 italic text-right text-xs">SON: {currencyCode} {totalInWords}</p>
        </div>
      </div>

      <div className="mt-6 flex justify-between gap-6">
        <div className="bg-[#f8f9fa] p-3 rounded-lg flex flex-col w-full justify-between">
          <p className="mb-3 font-bold text-left text-xs">AUTORIZADO POR</p>
