          ...
          <View style={styles.bottomSection}>
            <View style={styles.infoSection}>
              ...
              <View style={styles.infoList}>
                ...
                <Text style={styles.infoItem}>
                  • Esta nota de débito se emite para ajustar el saldo de la factura asociada
                </Text>
                <Text style={styles.infoItem}>• Los impuestos se calculan sobre el valor debitado</Text>
              </View>
