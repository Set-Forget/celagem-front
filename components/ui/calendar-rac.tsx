...
function CalendarHeader() {
  return (
    <header className="flex w-full items-center gap-1 pb-1">
      <Button
        slot="previous"
        className="text-muted-foreground/80 hover:bg-accent hover:text-foreground flex size-9 items-center justify-center rounded-md transition-[color,box-shadow]"
      >
          ...
          <CalendarCellRac
            ...
            className={cn(
              `text-foreground
               ...
               data-[selected][data-hovered]:bg-primary 
               data-[selected][data-hovered]:text-primary-foreground 
               relative flex size-9 items-center justify-center rounded-md p-0 text-sm font-normal whitespace-nowrap 
