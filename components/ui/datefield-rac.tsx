...
const dateInputStyle =
  "relative flex h-9 w-full items-center overflow-hidden placeholder:text-muted-foreground/70 text-foreground whitespace-nowrap rounded-sm border border-input bg-background px-3 py-2 text-sm shadow-sm shadow-black/5 transition-shadow data-[focus-within]:border-ring data-[disabled]:opacity-50 data-[focus-within]:outline-none data-[focus-within]:ring-ring/20";
