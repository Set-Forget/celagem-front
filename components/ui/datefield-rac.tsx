  ...
  return (
    <DateSegmentRac
      className={composeRenderProps(className, (className) =>
        cn(
          "text-foreground data-[focused]:bg-accent data-invalid:data-[focused]:bg-destructive data-[focused]:data-placeholder:text-foreground data-[focused]:text-foreground data-invalid:data-placeholder:text-destructive data-invalid:text-destructive data-[placeholder]:text-muted-foreground data-[type=literal]:text-muted-foreground/70 inline rounded p-0.5 caret-transparent outline-none data-disabled:cursor-not-allowed data-disabled:opacity-50 data-invalid:data-[focused]:text-white data-invalid:data-[focused]:data-placeholder:text-white data-[type=literal]:px-0",
          className,
        ),
      )}
      {...props}
