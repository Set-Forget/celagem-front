...
export default function NewPurchaseOrderPage() {
    const newPurchaseOrderForm = useForm<
        z.infer<typeof newPurchaseOrderSchema>
    >({
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col w-full">
                                    ...
                                    {newPurchaseOrderForm.formState.errors
                                        .supplier_name ? (
                                        <FormMessage>
                                            {
                                                newPurchaseOrderForm.formState
                                        ...
                                        <FormDescription>
                                            Esta será el proveedor al que se le
                                            emitirá la orden de compra.
                                        </FormDescription>
                                    )}
                                </FormItem>
                            )}
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col w-full">
                                    ...
                                    {newPurchaseOrderForm.formState.errors
                                        ...
                                        <FormDescription>
                                            Esta será la moneda en la que se
                                            emitirá la orden de compra.
                                        </FormDescription>
                                    )}
                                </FormItem>
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col w-full">
                                    ...
                                    {newPurchaseOrderForm.formState.errors
                                        ...
                                        <FormDescription>
                                            Este será el tipo de pago que se
                                            registrará.
                                        </FormDescription>
                                    )}
                                </FormItem>
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col w-full">
                                    ...
                                    {newPurchaseOrderForm.formState.errors
                                        ...
                                        <FormDescription>
                                            Sede a la que se le asignará la
                                            solicitud de compra.
                                        </FormDescription>
                                    )}
                                </FormItem>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col w-full md:col-span-2">
                                    ...
                                    <FormDescription>
                                        Estas notas son internas y no se
                                        incluirán en la orden de compra.
                                    </FormDescription>
                                </FormItem>
                            )}
                        />
