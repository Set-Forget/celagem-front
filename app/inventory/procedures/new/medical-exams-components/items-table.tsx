...
import { medicalExamSchema } from '@/app/inventory/medical-exams/schema/medical-exam';

export default function MedicalExamsItemsTable({ className }: { className?: string }) {
  const { control } = useFormContext<z.infer<typeof medicalExamSchema>>();
