...
export default function Page() {
  ...
  const { data: taxData, isLoading: isTaxLoading } =
  ...
  return (
    <>
      <Header title="Detalles del impuesto">
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            onClick={() => router.push(`/accounting/extras/taxes/edit/${taxId}`)}
            size="sm"
          >
        ...
        >
          ...
          <div className="p-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                {isTaxLoading ? placeholder(13) : 'Hace 3 días'}
              </span>
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-muted-foreground text-sm">
                ...
                >
                  {isTaxLoading
                    ? placeholder(13)
                    : taxData?.updated_by?.first_name +
                    ' ' +
                    taxData?.updated_by?.last_name}
                </span>
              </label>
              <span
                className={cn(
