    ...
    <>
      <Header title="Detalles del material">
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            onClick={() => router.push(`/register/materials/edit/${materialId}`)}
            size="sm"
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <span
                className={cn(
                  ...
                  isMaterialLoading ? 'blur-[4px]' : 'blur-none'
                )}
              >
            ...
            {/*  <div className="flex flex-col gap-1">
              <label className="text-muted-foreground text-sm">
                ...
                >
                  {isMaterialLoading
                    ? placeholder(13)
                    : materialData?.updated_by?.first_name +
                      ' ' +
                      materialData?.updated_by?.last_name}
                </span>
              </label>
              <span
                className={cn(
