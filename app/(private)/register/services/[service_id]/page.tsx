    ...
    <>
      <Header title="Detalles del servicio">
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            onClick={() => router.push(`/register/services/edit/${serviceId}`)}
            size="sm"
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <span
                className={cn(
                  ...
                  isServiceLoading ? 'blur-[4px]' : 'blur-none'
                )}
              >
                {isServiceLoading ? placeholder(13) : 'Hace 3 días'}
              </span>
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-muted-foreground text-sm">
                ...
                >
                  {isServiceLoading
                    ? placeholder(13)
                    : serviceData?.updated_by?.first_name +
                      ' ' +
                      serviceData?.updated_by?.last_name}
                </span>
              </label>
              <span
                className={cn(
