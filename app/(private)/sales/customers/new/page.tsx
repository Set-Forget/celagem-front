                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.commercial_company_name ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.currency ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                          Esta será la moneda en la que se registrarán las transacciones del cliente.
                        </FormDescription>
                      }
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.tax_type ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.tax_id ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                          Este será el CUIT/NIT del cliente que se registrará.
                        </FormDescription>
                      }
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.property_payment_term ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                          Este será la condición de pago del cliente que se registrará.
                        </FormDescription>
                      }
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                              ...
                              <CommandGroup>
                                {payment_methods.map((type) => (
                                  <CommandItem
                                    ...
                                    key={type.value}
                                    onSelect={() => {
                                      newCustomerForm.setValue("payment_method", type.value, { shouldValidate: true });
                                    }}
                                  >
                                    {type.label}
                      ...
                      {newCustomerForm.formState.errors.payment_method ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.tax_regime ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                          Este será el regimen tributario del cliente que se registrará.
                        </FormDescription>
                      }
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.tax_category ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                          Este será el regimen fiscal del cliente que se registrará.
                        </FormDescription>
                      }
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.tax_information ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                          Este será la información tributaria del cliente que se registrará.
                        </FormDescription>
                      }
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.fiscal_responsibility ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                          Este será la responsabilidad fiscal del cliente que se registrará.
                        </FormDescription>
                      }
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                              ...
                              <CommandGroup>
                                {economic_activity.map((type) => (
                                  <CommandItem
                                    ...
                                    key={type.value}
                                    onSelect={() => {
                                      newCustomerForm.setValue("economic_activity", type.value, { shouldValidate: true });
                                    }}
                                  >
                                    {type.label}
                                    <Check className={cn("ml-auto", type.value === field.value ? "opacity-100" : "opacity-0")} />
                      ...
                      {newCustomerForm.formState.errors.economic_activity ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                          Esta será la actividad económica del cliente que se registrará.
                        </FormDescription>
                      }
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.entity_type ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                          Este será el tipo de persona del cliente que se registrará.
                        </FormDescription>
                      }
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                      ...
                      {newCustomerForm.formState.errors.nationality_type ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
                          Este será el tipo de nacionalidad del cliente que se registrará.
                        </FormDescription>
                      }
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col w-full">
                              ...
                              <CommandGroup>
                                {accounts.map((account) => (
                                  <CommandItem
                                    ...
                                    key={account.number}
                                    onSelect={() => {
                                      newCustomerForm.setValue("accounting_account", account.number, { shouldValidate: true })
                                    }}
                                  >
                      ...
                      {newCustomerForm.formState.errors.accounting_account ? (
                        <FormMessage />
                      ) :
                        <FormDescription>
