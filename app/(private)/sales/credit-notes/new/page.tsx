                  ...
                  <Popover>
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(date) => {
                          if (!date) return
                          newCreditNoteForm.setValue("date", date?.toISOString(), { shouldValidate: true })
                        }}
                        initialFocus
                      />
                    </PopoverContent>
                  </Popover>
                  {newCreditNoteForm.formState.errors.date ? (
                    <FormMessage />
                  ) :
                    <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col w-full">
                  ...
                  {newCreditNoteForm.formState.errors.payment_term ? (
                    <FormMessage />
                  ) :
                    <FormDescription>
