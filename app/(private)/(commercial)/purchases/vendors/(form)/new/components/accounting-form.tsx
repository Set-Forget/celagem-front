...
export default function AccountingForm() {
  ...
  const { initialOptions: initialAccountingAccounts, fetcher: handleSearchAccountingAccount } = useAccountingAccountSelect({
          ...
          <FormItem className="flex flex-col w-full">
            ...
            <FormControl>
              <AsyncSelect<{ id: number, name: string, code: string }, number>
                ...
                getOptionKey={(item) => String(item.id)}
                noResultsMessage="No se encontraron resultados"
                initialOptions={initialAccountingAccounts}
              />
            </FormControl>
