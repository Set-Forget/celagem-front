...
export default function Page() {
  ...
  return (
    <>
      <Header title="Detalles del atributo">
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            onClick={() => router.push(`/inventory/attributes/edit/${attributeId}`)}
            size="sm"
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <span
                className={cn(
                  ...
                  isAttributeLoading ? 'blur-[4px]' : 'blur-none'
                )}
              >
                {isAttributeLoading ? placeholder(13) : 'Hace 3 días'}
              </span>
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-muted-foreground text-sm">
                ...
                >
                  {isAttributeLoading
                    ? placeholder(13)
                    : attributeData?.updated_by?.first_name +
                      ' ' +
                      attributeData?.updated_by?.last_name}
                </span>
              </label>
              <span
                className={cn(
