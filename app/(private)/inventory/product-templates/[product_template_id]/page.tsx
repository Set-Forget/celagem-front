...
export default function Page() {
  ...
  return (
    <>
      <Header title="Detalles de la plantilla de producto">
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            onClick={() => router.push(`/inventory/product-templates/edit/${productTemplateId}`)}
            size="sm"
          >
            <Pencil className="w-4 h-4" />
            Editar plantilla de producto
          </Button>
        </div>
      </Header>
      <ResizablePanelGroup
            ...
            <div className="flex flex-col gap-1">
              ...
              <span
                className={cn(
                  ...
                  isProductTemplateLoading ? 'blur-[4px]' : 'blur-none'
                )}
              >
                {isProductTemplateLoading ? placeholder(13) : 'Hace 3 días'}
              </span>
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-muted-foreground text-sm">
                ...
                >
                  {isProductTemplateLoading
                    ? placeholder(13)
                    : productTemplateData?.updated_by?.first_name +
                      ' ' +
                      productTemplateData?.updated_by?.last_name}
                </span>
              </label>
              <span
                className={cn(
