...
export default function Page() {
  ...
  return (
    <>
      <Header title="Detalles del material">
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            onClick={() =>
              router.push(`/inventory/locations/edit/${locationId}`)
            }
            size="sm"
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <span
                className={cn(
                  ...
                  isLocationLoading ? 'blur-[4px]' : 'blur-none'
                )}
              >
                {isLocationLoading ? placeholder(13) : 'Hace 3 días'}
              </span>
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-muted-foreground text-sm">
                ...
                >
                  {isLocationLoading
                    ? placeholder(13)
                    : locationData?.updated_by?.first_name +
                      ' ' +
                      locationData?.updated_by?.last_name}
                </span>
              </label>
              <span
                className={cn(
