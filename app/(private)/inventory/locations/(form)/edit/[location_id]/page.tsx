...
import { useGetLocationQuery, useUpdateLocationMutation } from '@/lib/services/locations';
...
export default function Page() {
  ...
  const { data: locationData } = useGetLocationQuery(locationId, {
    skip: !locationId,
  });
  ...
  useEffect(() => {
    if (locationData) {
      form.reset({
        ...locationData,
        created_by: locationData.created_by?.id,
      });
    }
  }, [locationData]);
  ...
  return (
    <Form {...form}>
      <Header title="Actualizar ubicacion">
        <Button
          type="submit"
