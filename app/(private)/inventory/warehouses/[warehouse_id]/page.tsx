...
export default function Page() {
  ...
  return (
    <>
      <Header title="Detalles del almacén">
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            onClick={() => router.push(`/inventory/warehouses/edit/${warehouseId}`)}
            size="sm"
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <span
                className={cn(
                  ...
                  isWarehouseLoading ? 'blur-[4px]' : 'blur-none'
                )}
              >
                {isWarehouseLoading ? placeholder(13) : 'Hace 3 días'}
              </span>
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-muted-foreground text-sm">
                ...
                >
                  {isWarehouseLoading
                    ? placeholder(13)
                    : warehouseData?.updated_by?.first_name +
                      ' ' +
                      warehouseData?.updated_by?.last_name}
                </span>
              </label>
              <span
                className={cn(
