...
export default function Page() {
  ...
  return (
    <>
      <Header title="Detalles de la moneda">
        <div className="ml-auto flex items-center gap-2">
          ...
          <Button
            onClick={() => router.push(`/accounting/extras/currencies/edit/${currencyId}`)}
            size="sm"
          >
        ...
        >
          ...
          <div className="p-4 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              >
                {isCurrencyLoading ? placeholder(13) : 'Hace 3 días'}
              </span>
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-muted-foreground text-sm">
                ...
                >
                  {isCurrencyLoading
                    ? placeholder(13)
                    : currencyData?.updated_by?.first_name +
                      ' ' +
                      currencyData?.updated_by?.last_name}
                </span>
              </label>
              <span
                className={cn(
