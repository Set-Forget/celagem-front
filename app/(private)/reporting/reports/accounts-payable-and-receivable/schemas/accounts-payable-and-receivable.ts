...
const accountsPayableAndReceivableListSchema = z.object({
  id: z.number(),
  date: z.string(),
  partner: z.string(),
...
export type AccountsPayableAndReceivableList = z.infer<typeof accountsPayableAndReceivableListSchema>;